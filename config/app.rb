...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-sync-bug.com'
  config.app_name = 'Volt-sync-bug'
  config.mailer.from = 'Volt-sync-bug <no-reply@volt-sync-bug.com>'
  ...
  #
  config.app_secret = 'Nw02vHFvThTW35NwkGaogb16iVGXqvFznBnF58LqpCXEg9-Igh-JCKx0kTL1PgSXxRs'
